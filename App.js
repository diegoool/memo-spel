...
export default class App extends React.Component {
  ...
  constructor(props) {
    ...
    // create a completely new array from the array of cards
    let clone = JSON.parse(JSON.stringify(cards));

    // combine the original and the clone
    ...
    this.state = {
      // this array will contain an array of card objects which are currently selected by the user. This will only contain two objects at a time.
      current_selection: [],
      // the names of the icons. This array is used for excluding them from further selection
      selected_pairs: [], 
      // default user score
      score: 0,
      // the shuffled cards
